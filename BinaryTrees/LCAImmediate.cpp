...
bool LCA(Node* root , Node*&lowestCommonAncestor,Node* p ,Node* q){
    ...
    if(LCA(root->left,lowestCommonAncestor,p,q)) return true;
    if(LCA(root->right,lowestCommonAncestor,p,q)) return true;
...
int main(){
    ...
    LCA(root,lowestCommonAncestor,six,seven);
